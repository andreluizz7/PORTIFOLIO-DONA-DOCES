...
const addicionarAoCarrinhoBtns = document.querySelectorAll('.main__produtos__item__botao');
...
function adicionarAoCarrinho() {
  ...
  const botoesAdicionar = document.querySelectorAll(".main__produtos__item__botao");
  ...
  function inserirItemNoCarrinho(imgSrc, titulo, preco) {
  ...
  botoesAdicionar.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      inserirItemNoCarrinho(img.src, titulo.textContent, preco.textContent);
      // Aviso visual
